...
import static com.test.example.mareu.UI.meeting.add.AddMeetingActivity.DATE_MEETING_TAG;
...
String tag;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        if (tag.equals(DATE_MEETING_TAG)) datePickerDialog.getDatePicker().setMinDate(Calendar.getInstance().getTimeInMillis());
