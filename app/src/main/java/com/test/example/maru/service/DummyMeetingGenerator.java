...
public abstract class DummyMeetingGenerator {
    ...
    public static List<Meeting> DUMMY_MEETING = Arrays.asList(
            new Meeting(1L, generateMeetingDate(-1, -1, 30), generateMeetingDate(-1, 2, 0), "Salle B", "Kick-off", "Alex@lamzone.com, Maxime@lamzone.com, Pmandine@lamzone.com, Paul@lamzone.com"),
            ...
            new Meeting(4L, generateMeetingDate(0, -4, 15), generateMeetingDate(0, 3, 45), "Amphithéâtre", "Assemblé générale", " Anne@lamzone.com,  Bernard@lamzone.com,  Christiane@lamzone.com,  Claude@lamzone.com,  Isabelle@lamzone.com,  Madeleine@lamzone.com,  Marcel@lamzone.com,  Nicole@lamzone.com,  Philippe@lamzone.com,  Robert@lamzone.com,  Yvonne@lamzone.com, Monique@lamzone.com"),
